...
/*-------------------------------------------------------------------
 ...
 |  Returns:
 *-------------------------------------------------------------------*/
map<string, GLuint> AbsModels::loadTextures(QString folderName, QString filter){
    ...
    for(int i = 0; i < list.size(); i++){
        ...
        if(success){
            ...
            if(success){
                ...
                textureIdMap[textureName.toStdString()] = textureId; //Save textureId to the map
